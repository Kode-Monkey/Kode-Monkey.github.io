...
img-size: 100
meta-title: Accessibility Features
title: Accessibility Features
category: Accessibility Remediation
subtitle: Features Documentation
description: How to resolve Features accessibility issuse.
permalink: Accessibility-Remidation/Structural-Features
---
...
<p>If at any time you do not understand how to resolve and issue please reach out to your accessibiltiy specalist for further explination.</p>
  ...
  <!-- Tab #Features-->
  <div id="collapse-features" class="collapse show" aria-labelledby="accessibility-features" data-parent="#TabMenu">
    <!-- Content -->
