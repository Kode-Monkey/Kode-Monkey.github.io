...
<ul>
  ...
  <ul>
    ...
    <li><a href="https://www.startpage.com/" target="_blank">Startpage</a>: If you prefer Google’s search results and just want more privacy, try Ixquick’s Startpage.</li>
    <li><a href="https://ixquick.com/" target="_blank">Ixquick</a>: Ixquick is the main search engine from the company that runs Startpage. Unlike Startpage, Ixquick pulls results from a variety of sources instead of only Google.</li>
  </ul>
  </li>
